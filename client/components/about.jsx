...
export default function About() {
  ...
  return (
    <div className={classes.root} id='about-content-wrap'>
      <h1 className={`${classes.aboutUsHeader} about-us-header-lg`}>About Us</h1>
      <div className={classes.pStyling}>
        <p className="about-us-p-lg">Hi there! Zoomies realizes that we are all going through difficult times right now
          ...
          some four-legged (sometimes three) friends that are sure to leave a smile on anyone’s face!</p>
        ...
        <p className="about-us-p-lg">Volunteers at our partner organizations are ready to assist with your virtual therapy session and our good boys
